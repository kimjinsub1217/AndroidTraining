...
class MainActivity : AppCompatActivity() {
    ...
    private var obsevarbleTextQuery: Disposable? = null
    ...
    override fun onDestroy() {
        super.onDestroy()
        obsevarbleTextQuery?.dispose()
        obsevarbleTextQuery = null
    }

    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.options_menu, menu)
        obsevarbleTextQuery =
            io.reactivex.rxjava3.core.Observable.create { emitter: ObservableEmitter<String>? ->
