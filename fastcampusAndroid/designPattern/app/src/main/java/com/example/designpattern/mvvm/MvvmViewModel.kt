...
import com.example.designpattern.mvvm.repository.ImageRepository
...
class MvvmViewModel(private val imageRepository: ImageRepository) : ViewModel() {
    ...
    private val _imageLivaData = MutableLiveData<Image>()
    val imageLiveData: LiveData<Image> by lazy { _imageLivaData }
